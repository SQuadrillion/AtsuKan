...
extern void *mono_aot_module_Atumori_iOS_info;
...
extern void *mono_aot_module_OxyPlot_Xamarin_Forms_Platform_iOS_info;
extern void *mono_aot_module_OxyPlot_Xamarin_Forms_info;
extern void *mono_aot_module_OxyPlot_info;
extern void *mono_aot_module_OxyPlot_Xamarin_iOS_info;
extern void *mono_aot_module_Atumori_info;
...
{
	mono_aot_register_module (mono_aot_module_Atumori_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_OxyPlot_Xamarin_Forms_Platform_iOS_info);
	mono_aot_register_module (mono_aot_module_OxyPlot_Xamarin_Forms_info);
	mono_aot_register_module (mono_aot_module_OxyPlot_info);
	mono_aot_register_module (mono_aot_module_OxyPlot_Xamarin_iOS_info);
	mono_aot_register_module (mono_aot_module_Atumori_info);
...
void xamarin_register_assemblies_impl ()
{
	...
	xamarin_process_managed_exception_gchandle (exception_gchandle);
	xamarin_open_and_register ("OxyPlot.Xamarin.Forms.Platform.iOS.dll", &exception_gchandle);
	xamarin_process_managed_exception_gchandle (exception_gchandle);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "Atumori.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 2;
